...
find_parameters (char **start_dir, char **pattern, char **content)
{
  ...
  find_par_start:
    ...
    in_with = input_new (6, FIND_X / 2 + 1, USE_DEFAULT_COLORS, FIND_X / 2 - 4, INPUT_LAST_TEXT,
                         MC_HISTORY_SHARED_SEARCH, INPUT_COMPLETE_DEFAULT);
    add_widget (find_dlg, in_with);
    add_widget (find_dlg, label_new (5, FIND_X / 2 + 1, _("Content:")));

    in_name = input_new (6, 3, USE_DEFAULT_COLORS,
    ...
    in_start = input_new (3, 3, USE_DEFAULT_COLORS,
