...
display_init (int radio_sel, char *init_text, int _check_status, char **_status)
{
    ...
    display_mini_status = input_new (10, 8, USE_DEFAULT_COLORS, dlg_width - 12, _status[radio_sel],
    ...
    display_user_format = input_new (7, 8, USE_DEFAULT_COLORS, dlg_width - 12, init_text,
